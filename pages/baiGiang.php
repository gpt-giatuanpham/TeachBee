...
<body>
        ...
        <div class="row">
          ...
          <div class="col-6 col-sm-8 col-md-8 col-lg-9 col-xl-7 py-2">
            <div class="myNavbar__left">
              ...
              <form class="myNavbar__FormSearch1" id="lectureSearchForm">
                <div class="input-group">
                  <input type="text" id="lectureSearchInput" class="form-control" placeholder="Search" />
  ...
  <main>
    ...
    <div id="notLoggedIn" style="display:none; text-align:center; padding:60px 20px;">
      <p style="font-size:1rem; color:#6b7280;">
        Please <a href="../pages/register.php" style="color:#5925DC; font-weight:600;">log in</a> to access.
      </p>
    </div>
    <div id="mainContent">
      <!-- tao bài giảng -->
      <section class="create__lecture">
        <div class="container">
          <div class="create__lecture__content">
            <div class="create__lecture__btn d-flex align-items-center column-gap-2" id="openUploadModal" style="cursor: pointer;">
              ...
              <p class="createLectureTitle" href="#">Upload new files here</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- danh sách bài giảng -->
      <section class="lecture__list">
        <div class="container">
          <div class="lecture__selector">
            <div class="lecture__selector__top d-flex justify-content-between">
              <div class="lecture__selector__top__left d-flex align-items-center">
                <h4>Your audio files</h4>
              </div>
            </div>

            <!-- Lecture cards will appear here -->
            <div id="lectureListContainer"></div>
          </div>
        </div>
      </section>
    </div>
  ...
  <div class="upload-modal-overlay" id="uploadModalOverlay">
    <div class="upload-modal">
      <button class="upload-modal__close" id="closeUploadModal" title="Đóng">&times;</button>

      <h5>Upload new files</h5>
      <p class="subtitle">Supported formats: .mp3, .wav, .ogg, .m4a — 50 MB maximum</p>

      <!-- Drop zone -->
      <div class="drop-zone" id="dropZone">
        <div class="drop-zone__icon">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#5925DC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
            <polyline points="17 8 12 3 7 8"/>
            <line x1="12" y1="3" x2="12" y2="15"/>
          </svg>
        </div>
        <p><span class="browse-link" id="browseLink">Choose your files</span> or drag them here</p>
        <span>.mp3 · .wav · .ogg · .m4a</span>
        <input type="file" id="audioFileInput" accept=".mp3,.wav,.ogg,.m4a,audio/*" style="display:none;">
      </div>
      ...
      <div class="file-preview" id="filePreview">
        ...
        <div class="file-preview__info">
          <p class="file-preview__name" id="fileName">—</p>
          <p class="file-preview__size" id="fileSize">—</p>
        </div>
        <button class="file-preview__remove" id="removeFile" title="Xóa">&times;</button>
      </div>

      <!-- Lecture title -->
      <div style="margin-top:20px;">
        <label for="lectureTitle">Lecture title</label>
        <input type="text" id="lectureTitle" placeholder="Eg. Unit 1 - Atomic theory">
      </div>

      <!-- Progress -->
      <div class="progress-wrap" id="progressWrap">
        <p id="progressLabel">Loading… 0%</p>
      ...
      <div class="upload-modal__actions">
        ...
        <button class="btn-upload" id="submitUpload" disabled>Submit</button>
      </div>
    </div>
  </div>
